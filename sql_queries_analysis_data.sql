...
select count(distinct Industry) total_job_domains
from job_view;
...
# Which Company has the highest number of jobs for each Career Level? 
with t1 as(
...
# Which Industry has the highest number of jobs for each Career Level?
with t1 as(
...
# Which Company has the highest number of jobs for each analytics fields?
with t1 as(
...
# Which Industry has the highest number of jobs for each analytics fields?
with t1 as(
...
# what is the total number of jobs for analytics fields grouped by career level?  
